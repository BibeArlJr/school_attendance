...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 supports-backdrop-filter:backdrop-blur-xs fixed inset-0 isolate z-50 bg-black/10 duration-100',
        className,
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        '*:[a]:hover:text-foreground *:[a]:underline *:[a]:underline-offset-3 text-sm text-muted-foreground',
        className,
      )}
      {...props}
    />
